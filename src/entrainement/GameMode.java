...
public abstract class GameMode {
	...
	public void recupererChoixHuman() {
		...
		System.out.print("Entrez votre proposition ра4 chiffres s'il vous plait : "); // modification le 08/03 pour
	...
	public String[] comparerValeurs2(int[] proposition, int[] combinaisonadeviner) { // proposition &
		...
		for (int i = 0; i < 4; i++) {
			...
			View.comparerValeur2 += result[i]; // mets bout ├а bout les valeurs de result soit +/=/-
		}
